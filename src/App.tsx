      ...
      <div className="mx-auto grid w-full max-w-7xl gap-6 px-4 py-6 lg:grid-cols-[minmax(0,1fr)_390px] lg:px-6">
        <section className="grid content-start gap-5">
          <header className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
            ...
            <h1 className="mt-2 text-3xl font-bold tracking-normal text-zinc-950 md:text-5xl">
              Algorithm explorer
            </h1>
            <p className="mt-3 max-w-3xl text-sm leading-6 text-zinc-600 md:text-base">
              Generate a perfect maze, choose a strategy, and watch the visited
              cells, queued candidates, active head, route previews, and final
              route appear frame by frame.
            </p>
